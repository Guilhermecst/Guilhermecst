# Olá! Eu sou Guilherme Costa, Analista de Dados & Desenvolvedor de BI
...
Meu trabalho se concentra em fechar a lacuna entre os dados e o *insight*. Crio soluções que automatizam a coleta, garantem a qualidade e a performance dos dados, e os traduzem em histórias visuais claras e objetivas.

## 🛠️ Stack de Tecnologias

Estas são as principais ferramentas e técnicas que utilizo no meu dia a dia para construir soluções de ponta a ponta:
...
Meus projetos refletem o ciclo completo da análise de dados: da coleta à visualização.

### 🏈 NFL Stats: Web Scraping, ETL e Power BI
* **Descrição:** Um projeto completo de ponta a ponta, onde utilizei **Web Scraping** com Python para extrair estatísticas detalhadas da NFL. O foco foi na **Modelagem Dimensional (Star Schema)** dos dados brutos e na criação de um **Dashboard Interativo no Power BI**.
* **Habilidades Demonstradas:** Coleta automatizada de dados, limpeza complexa (Pandas), modelagem para BI e visualização.
* **Link Rápido:** [Acesse o Repositório de Scripts](https://github.com/Guilhermecst/NFL_Stats/tree/main/Scripts)

### 📈 [Nome de Outro Projeto Relevante - Ex: Análise de E-commerce, Previsão de Vendas, etc.]
* **Descrição:** Breve descrição do seu segundo projeto mais importante.
* **Habilidades Demonstradas:** (Ex: Cloud Computing, Machine Learning, Dashboards Avançados).

### ⚙️ [Nome de Outro Projeto Relevante - Ex: Pipeline de Dados com Airflow, etc.]
